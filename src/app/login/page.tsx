    ...
    <div className="min-h-screen flex items-center justify-center bg-brand-surface px-4">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-md border border-gray-100 p-8">
        <div className="mb-8 flex flex-col items-center text-center">
          <Logo size={56} />
          <div className="text-xs font-medium text-gray-400 tracking-wide mt-3">Dipstify</div>
          ...
          <div className="text-sm text-gray-500 mt-1">HR and Payroll for SMEs</div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full border border-gray-200 rounded-lg px-3 py-2 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-brand-blue-600"
                placeholder="..."
              />
              <button
                type="button"
